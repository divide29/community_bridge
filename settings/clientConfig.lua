...
BridgeClientConfig.MenuSystem        = "auto"       -- [ auto | ox_lib | lation_ui | wasabi_uikit | qb-menu ]
BridgeClientConfig.ProgressBarSystem = "auto"       -- [ auto | ox_lib | lation_ui | wasabi_uikit | keep-progressbar | progressbar ]
